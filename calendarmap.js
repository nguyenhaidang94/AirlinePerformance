...
function color(d) {
  ...
  if(d.DEP_DEL15 >= 10 && d.DEP_DEL15 < 14.167818){
    return '#ebf582';
  }
  if(d.DEP_DEL15 >= 14.167818 && d.DEP_DEL15 < 17.815043){
    return '#e8a468'
  }
  if(d.DEP_DEL15>=17.815043 && d.DEP_DEL15 < 22.449519){
    return '#f76834';
  }
  if(d.DEP_DEL15>=22.449519){
    return 'red';
  }
}
